...
public class GUI_main {
	...
	public static void main(final String[] args) {
		...
		for(CTFile ctfile : parameter.ctfiles){
			ctfile.importV2000(parameter.m_ID, parameter.m_minNOS, parameter.m_minO, parameter.m_minBackboneLength, parameter.m_maxBackboneLength, parameter.m_sdfileOutput, mols);
		}
